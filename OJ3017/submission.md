...
```text
โจทย์ให้คำนวนราคาอาหารที่เพิ่มค่าบริการและภาษี

Input:
ราคาอาหารเป็นจำนวนเต็ม

Output:
เงินที่ต้องชำระ ทศนิยม 2 ตำแหน่ง

Constraints:
ค่าบริการขั้นต่ำ 50 แต่ไม่เกิน 1000
```
...
step 2: นำราคาอาหารไปคูณ 0.1 เพื่อหาค่าบริการ
step 3: ตรวจสอบค่าบริการว่าต่ำกว่า 50 หรือสูงกว่า 1000 หรือไม่ เพื่อปรับตามเงื่อนไข
step 4: คำนวณค่าภาษีจากราคาอาหารบวกกับค่าบริการ
step 5: รวมทั้งหมด
step 6: พิมพ์ราคาที่ต้องจ่าย
```
...
```text
เหมือนวิธีแรกสามารถใช้ได้ไม่มีข้อผิดพลาด
```
