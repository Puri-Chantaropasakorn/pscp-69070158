...
```text
โจทย์ให้หาสีหลังจากผสมเสร็จ

Input:
รับชื่อสีที่ 1 และ 2

Output:
ชื่อสีที่ผสมแล้ว

Constraints:
ระวังสีที่นอกเหนือจาก Red Blue Yellow
```
...
```text
Step 1: รับinputค่าสีสองสี
Step 2: ตรวจสอบสีแรกว่าเป็นอะไร
Step 3: ตรวจสอบสีที่สอง
Step 4: ถ้าเหมือนกันให้พิมพ์สีเดิม
Step 5: พิมพ์สีตามตารางการผสม
Step 6: ถ้านอกเหนือจากนั้นพิมพ์ Error
```
...
```text
เหมือนวิธีแรก ใช้ match case เช็คสีแรก แล้วค่อยเช็คสีที่สองต่อมา
```
