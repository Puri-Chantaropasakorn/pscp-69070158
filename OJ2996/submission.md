...
```text
โจทย์ให้สลับตัวอักษรจากหลังมาหน้า

Input:
ตัวอักษร5ตัว

Output:
ตัวอักษรที่ผ่านการสลับและเปลี่ยนเป็นตัวพิมพ์เล็ก

Constraints:
ระวังเรื่องoutputจะต้องเป็นตัวพิมพ์เล็กเท่านั้น
```
...
```text
step 1: รับinput
step 2: นำไปสลับจากหลังมาหน้า แล้วทำเป็นตัวพิมพ์เล็ก
step 3: พิมพ์คำตอบ
```
...
```text
วิธีสุดท้ายเหมือนแผนแรก ใช้ index str ในการสลับ และ case fold เพื่อทำให้เป็นตัวพิมพ์เล็ก
```
